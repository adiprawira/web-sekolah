...
<head>
    ...
    <title>SMK Agak Pintar <?= $title ?></title>
    ...
    <!-- Timeline CSS -->
    <link href="<?= base_url() ?>template/back-end//css/timeline.css" rel="stylesheet">
    ...
    <!-- Morris Charts CSS -->
    <link href="<?= base_url() ?>template/back-end//css/morris.css" rel="stylesheet">
