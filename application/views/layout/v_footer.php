...
<footer class="footer">
    <div class="footer_background" style="<?= base_url() ?>template/front-end/background-image:url(images/footer_background.png)"></div>
    <div class="container">
                        ...
                        <div class="col-lg-3 footer_col">
                            ...
                            <div class="footer_section footer_about">
                                <div class="footer_logo_container">
                                    <a href="#">
                                        <div class="footer_logo_text">SMK<span> Agak Pintar</span></div>
                                    </a>
                                </div>
                                <div class="footer_about_text">
                                    <p>"Jangan Malas Sekolah,Jika tidak mau menyesal di masa depan"</p>
                                </div>
                        ...
                        <div class="col-lg-3 footer_col">
                            ...
                            <div class="footer_section footer_contact">
                                ...
                                <div class="footer_contact_info">
                                    <ul>
                                        <li>Email: Info.smkagakpintar@gmail.com</li>
                                        <li>Phone: +(88) 111 555 666</li>
                                        <li>Jalanin aja dulu ,Korea Selatan, Seoul</li>
                                    </ul>
                                </div>
                            </div>
